...
class App
{
    ...
    public function auth($userName)
    {
        ...
        // Añade el nombre de usuario a la sesion
        // Redirección a ?option=menu para que se lance home() desde 20.php
    ...
    {
        // Sprintf con la routa (constante) y el nombre de usuario (sesion) para tener la routa del archivo del usuario
    ...
    // Funcion close()
    // Se lanza desde 20.php

    public function close()
    {
        // Borra la sesión y redirect a 20.php para que lance login()
